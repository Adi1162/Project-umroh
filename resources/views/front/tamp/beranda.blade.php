...
@section('content')
  ...
  <section id="hero" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      <h1>Pengalaman Umroh<br>bersama Kurnia Mardani Tour</h1>
      <h2>Selamat datang di Biro Travel Kurnia Mardani Tour, penyelenggara perjalanan umroh yang berkomitmen memberikan pelayanan terbaik bagi para jamaahnya. Pendaftaran umroh bersama kami adalah langkah awal menuju perjalanan ibadah yang penuh makna dan kenyamanan</h2>
